...
#define _BL(objectWithBundle) (ARTConfigManager.sharedManager.showBundle ? [NSString stringWithFormat:@"<font size=%.0f><a href='%@://%@' color=%@>[%@]</a></font>", ceilf(ARTFontManager.sharedFontManager.themeFont.pointSize * .5), kSchemeBundle, objectWithBundle.bundleName, kColorBundle, objectWithBundle.bundleName] : @"")
